...
public abstract class AbstractEnvironment implements ConfigurableEnvironment {
	 ...
	 */
	// eg1: new ApplicationServletEnvironment()
	 ...
	 * @see #customizePropertySources(MutablePropertySources)
	 */
	// eg1: new ApplicationServletEnvironment()   propertySources=new MutablePropertySources()
	protected AbstractEnvironment(MutablePropertySources propertySources) {
		this.propertySources = propertySources;
		this.propertyResolver = createPropertyResolver(propertySources);
		// eg1: 由于class ApplicationServletEnvironment extends StandardServletEnvironment
		// 所以：调用的是StandardServletEnvironment的customizePropertySources方法
	 ...
	 */
	// eg1: propertySources=new MutablePropertySources()
	...
	// eg1: new ApplicationConversionService()
	@Override
