...
public abstract class PropertiesLoaderUtils {
	 ...
	 * @throws IOException if loading failed
	 */
	// eg1: resource [jar:file:/Users/muse/.m2/repository/org/springframework/boot/spring-boot/2.5.1/spring-boot-2.5.1.jar!/META-INF/spring.factories]
	public static void fillProperties(Properties props, Resource resource) throws IOException {
		try (InputStream is = resource.getInputStream()) {
			// eg1: spring.factories
			...
			if (filename != null && filename.endsWith(XML_FILE_EXTENSION)) {
				...
				// eg1: 把spring-boot-2.5.1.jar包下的spring.factories文件配置的信息，加载到props实体类中。
				props.load(is);
			}
		}
	}
